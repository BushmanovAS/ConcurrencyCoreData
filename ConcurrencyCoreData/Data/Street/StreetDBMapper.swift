...
final class StreetDBMapper: IDataBaseMapper {
    ...
    func toEntity(from domain: Street, context: NSManagedObjectContext) -> StreetEntity {
    ...
    func toEntities(from domains: [Street], context: NSManagedObjectContext) -> [StreetEntity] {
